...
() {
  ...
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_SUBSEGMENT_SEPARATOR='%F{008}  %F{008}' # separate segments with a space
  ...
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR='%F{002}/%F{002}'
  ...
  local anchor_files=( # Don't shorten directories that contain any of these files. They are anchors.
    .bzr
    .citc
    .git
    .hg
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%4F'  # green foreground
