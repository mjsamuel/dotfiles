...
- **Domain docs** — where `.mjsamuel/CONTEXT.md` and ADRs live, and the consumer rules for reading them
...
> Explainer: The "issue tracker" is where issues live for this repo. Skills like `to-issues`, `triage`, `to-prd`, and `qa` read from and write to it — they need to know whether to call `gh issue create`, write a markdown file under `.mjsamuel/scratch/`, or follow some other workflow you describe. Pick the place you actually track work for this repo.
...
- The `## Agent skills` block to add to `CLAUDE.local.md`
- The contents of `.mjsamuel/agents/issue-tracker.md`, `.mjsamuel/agents/triage-labels.md`, `.mjsamuel/agents/domain.md`

Let them edit before writing.

### 4. Write

**Target file: always `CLAUDE.local.md`** — create it at the repo root if it doesn't exist. If an `## Agent skills` block already exists in `CLAUDE.local.md`, update its contents in-place rather than appending a duplicate. Don't overwrite user edits to the surrounding sections.
...
[one-line summary of where issues are tracked]. See `.mjsamuel/agents/issue-tracker.md`.

### Triage labels

[one-line summary of the label vocabulary]. See `.mjsamuel/agents/triage-labels.md`.
