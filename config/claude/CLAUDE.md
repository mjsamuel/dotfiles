...
- When referencing line numbers or code locations, ALWAYS include the full file
  path (e.g., 'src/foo/bar.ts:42' not just 'line 42').
...
- Readablity is important
  - Prefer guard statements to return early and avoid unnecessary nesting.
